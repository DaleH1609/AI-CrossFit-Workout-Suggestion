  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <div className="mt-6 flex flex-col gap-3">
        <button
          onClick={handleShare}
          className="w-full py-3 bg-accent text-on-accent text-sm font-bold tracking-wider rounded-btn hover:bg-accent-90 transition-colors active:scale-[0.98] flex items-center justify-center gap-2"
        >
